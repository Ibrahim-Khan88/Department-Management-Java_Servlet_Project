	...
	<div class="container">
		...
		<div class="login-content">
			<form action="Loginservlet" method='post' id="form">
				...
				<input type="submit" class="btn" value="Login"> <a >Teacher?
					<span style="cursor: pointer;" onclick="forward('TeacherLogin.jsp')">Login</span>
				</a> <a >Authority? <span style="cursor: pointer;" onclick="forward('AuthorityLogin.jsp')">Login</span></a>
				 <a style="margin-top : 20px;" >Don't have any account? <span style="cursor: pointer;" onclick="forward('SignUp.jsp')">SignUp</span></a>
			</form>
		</div>
	</div>
