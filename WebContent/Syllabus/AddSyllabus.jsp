...
<body>
	...
	<div class="All-wrapper">
		<form action="AddSyllabus" method='post' id="form">
			<div class="row">
				<!-- section title -->
				<div style="width: 100%;">
					<div class="section-title">
						<h2 id="title-section">Syllabus</h2>
					</div>
				</div>
			</div>
					...
					<div class="card card-5">
						...
						<div class="card-body">
							...
							<div class="form-row">
								...
								<div class="value">
									<div class="input-group input-border-under-class">
										<input id="courseName" class="input--style-5" type="text"
											name="courseName">
									</div>
								</div>
							...
							<div class="form-row">
								...
								<div class="value">
									<div class="input-group input-border-under-class">
										<input class="input--style-5" type="text" id="courseCode"
											name="courseCode">
									</div>
								</div>
							...
							<div class="form-row">
								...
								<div class="value">
									<div class="input-group input-border-under-class">
										...
										<textarea class="input--style-5" id="Syllabus" class="input" name="Syllabus" rows="5"
											cols="20"></textarea>
									</div>
								</div>
			...
			<div class="login-wrap">
				<div class="login-html">
					...
					<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label
						for="tab-1" class="tab">Add Syllabus</label> <input
					...
					<div class="login-form">
						<div class="sign-in-htm">
							...
							<div class="group">
								...
								<textarea id="Syllabus" class="input" name="Syllabus" rows="5"
									cols="20"></textarea>
							</div>
